...
class MockEntityManager implements EntityManagerInterface {
    ...
    public function getClassMetadata( $className ){
        ...
        if( $className === 'Recognize\ApiBundle\Tests\Mocks\MockPrimaryEntity'){
            ...
            $classmetadata->associationMappings = array(
                "field1" => array(
                    "targetEntity" => 'Recognize\ApiBundle\Tests\Mocks\MockSecondaryEntity'
                )
            );

        } else if( $className === 'Recognize\ApiBundle\Tests\Mocks\MockSecondaryEntity' ){
            $classmetadata->fieldMappings = array(
                "field2"  => ""
            );
            ...
            $classmetadata->associationMappings = array(
                "field2" => array(
                    "targetEntity" => 'Recognize\ApiBundle\Tests\Mocks\MockTertiaryEntity'
                )
            );

        } else if( $className === 'Recognize\ApiBundle\Tests\Mocks\MockTertiaryEntity' ){
            $classmetadata->fieldMappings = array(
                "price"  => ""
            );
        }
